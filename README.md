...
- 大黑 K 跌破／貼近白線雷達：日線搜尋最近 3 個已完成交易日，週線搜尋最近 3 根已完成週 K。黑 K 開收實體跌幅必須至少 5%，下引線占整根高低區間嚴格小於 10%；同一根實體由白線上方穿越到收盤位於白線下方，或雖未穿越但收盤距 AI Momentum 白線在 ±1% 內，皆會列入。字卡會分別標示「實體跌破白線」或「收盤貼近白線」。可切換日／週及全部／台股／美股／其他市場，每張字卡顯示實體跌幅、下引線比例、收盤距白線、實體占比、OHLC、白線值、訊號 K 與首次顯示時間，並提供日線、週線各自的一鍵 TradingView TXT 輸出。
...
大黑 K 雷達的日線／週線一鍵輸出會沿用該區的市場篩選，輸出最近 3 根已完成 K 棒內符合「實體跌幅至少 5%、實體跌破白線或收盤距白線 ±1%、下引線占整根小於 10%」的標的；同一標的只保留一列。
