...
- 首頁最上方的日線白線／橙線站回雷達：前一交易日必須先有黑 K 實體由線上跌到線下；隔日開盤重新站上被跌破的同一條線時，僅於該市場正在交易期間列入左側「隔日開盤立即站回」，休市後不保留舊開盤事件。另外獨立保留每次跌破狀態，直到日後首次出現實體完全站回或紅 K 實體穿回時才列入右側「站回第一根」，不要求當天開盤在線上，並在休市時保留最新交易日結果。白線與橙線各自追蹤，並提供頁面／PWA 開啟期間的瀏覽器通知去重。
