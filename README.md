...
15 分鐘與 1 小時的 TD 訊號卡另提供「空方動能確認」。它依使用者提供的 AI Momentum [YinYang] 預設參數，以 TD 訊號**前 5 根已完成 K 棒**檢查是否出現空方動能，並要求黃色中線相較 3 根 K 棒前向下，以及 TD 訊號 K 棒位於趨勢帶下緣或跌破帶外。可用「僅空方動能確認」篩選；此為研究輔助條件，不是買賣建議。
