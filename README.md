...
- 首頁最上方的日線白線／橙線站回雷達：只要台股或美股先前已有黑 K 實體由線上跌到線下，且當日開盤高於同一條線的開盤基準，即於市場交易期間列入左側「隔日開盤立即站回」；休市後不保留舊開盤事件。右側「已確認站回第一根」只會在該市場日線收盤後，把首次實體完全站回或紅 K 實體穿回的標的加入名單，不會把盤中暫時站回當成已確認。白線與橙線各自追蹤，頂部可依線別（全部／白線／橙線）及市場（全部／台股／美股／其他）篩選，並提供頁面／PWA 開啟期間的瀏覽器通知去重。
